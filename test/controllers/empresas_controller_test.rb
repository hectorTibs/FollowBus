...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { Clave: @empresa.Clave, Localidad: @empresa.Localidad, Nombre: @empresa.Nombre } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { Clave: @empresa.Clave, Localidad: @empresa.Localidad, Nombre: @empresa.Nombre } }
